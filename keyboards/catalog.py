...
keyboard_choice_marks.new_button('1', 1, callback_data='mark1')
keyboard_choice_marks.new_button('2', 1, callback_data='mark2')
keyboard_choice_marks.new_button('3', 2, callback_data='mark3')
keyboard_choice_marks.new_button('4', 2, callback_data='mark4')
keyboard_choice_marks.new_button('5', 3, callback_data='mark5')
